    ...
    <div className="flex-1 flex flex-col h-full bg-slate-50/50">
      <div className="bg-white/80 backdrop-blur-xl border-b border-slate-200/60 px-6 py-5 flex items-center justify-between flex-shrink-0 sticky top-0 z-10 shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
        <div>
          ...
          <p className="text-[12.5px] text-[#64748B]">Analyze hospital revenue, claims, and department financial performance (INR ₹).</p>
        </div>
      ...
      <div className="flex-1 overflow-auto p-6 flex flex-col gap-6 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-4 gap-4">
          {[
            { label: "Total Revenue (MTD)", val: "₹2.4 Cr", trend: "+8.2%", color: "text-green-600" },
            { label: "Pending Insurance Claims", val: "₹84.5 L", trend: "-2.1%", color: "text-[#1B4FD8]" },
            { label: "Out of Pocket (Cash/UPI)", val: "₹32.0 L", trend: "+5.4%", color: "text-gray-900" },
            { label: "Average Revenue / Patient", val: "₹18,500", trend: "+1.2%", color: "text-gray-900" },
          ].map((stat, i) => (
          ...
          <div className="flex-1 bg-white border border-slate-200/60 rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col overflow-hidden">
             ...
             <div className="flex-1 p-8">
                ...
                <div className="space-y-6">
                  {[
                    { dept: "Surgery & OR", amount: "₹95,00,000", pct: 40, color: "bg-[#1B4FD8]" },
                    { dept: "Inpatient Wards", amount: "₹62,00,000", pct: 26, color: "bg-[#0284C7]" },
                    { dept: "Pharmacy", amount: "₹38,00,000", pct: 16, color: "bg-[#0EA5E9]" },
                    { dept: "Radiology & Imaging", amount: "₹25,00,000", pct: 10, color: "bg-[#38BDF8]" },
                    { dept: "Outpatient Clinics", amount: "₹20,00,000", pct: 8, color: "bg-[#7DD3FC]" },
                  ].map((row, i) => (
          ...
          <div className="w-96 bg-white border border-slate-200/60 rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col">
            ...
            <div className="p-8 flex-1 space-y-5 text-sm">
               <div className="flex justify-between items-center pb-3 border-b border-slate-100">
                 ...
                 <span className="font-bold text-slate-900 bg-slate-50 px-3 py-1 rounded-full">₹52,00,000</span>
               </div>
               <div className="flex justify-between items-center pb-3 border-b border-slate-100">
                 <span className="text-slate-500 font-medium">31-60 Days</span>
                 <span className="font-bold text-amber-600 bg-amber-50 px-3 py-1 rounded-full">₹21,00,000</span>
               </div>
               <div className="flex justify-between items-center pb-3 border-b border-slate-100">
                 <span className="text-slate-500 font-medium">61-90 Days</span>
                 <span className="font-bold text-red-500 bg-red-50 px-3 py-1 rounded-full">₹8,50,000</span>
               </div>
               <div className="flex justify-between items-center pb-3 border-b border-slate-100">
                 ...
                 <span className="font-bold text-rose-600 bg-rose-50 px-3 py-1 rounded-full">₹3,00,000</span>
               </div>
               ...
               <div className="mt-8 bg-gradient-to-br from-rose-50 to-red-50/50 border border-rose-200/60 rounded-[20px] p-5 shadow-sm relative overflow-hidden">
                 ...
                 <p className="text-[12.5px] text-rose-700/80 mb-4 leading-relaxed">Claim denials from Star Health increased by 4% this week due to missing pre-authorizations.</p>
                 <button className="text-[12.5px] font-bold text-rose-700 bg-white/60 hover:bg-white px-4 py-2 rounded-full transition-colors w-full text-center shadow-sm border border-rose-100 cursor-pointer">View Denied Claims</button>
               </div>
            </div>
          </div>
        </div>
