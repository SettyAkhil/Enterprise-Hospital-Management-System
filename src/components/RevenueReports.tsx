      ...
      <div className="bg-white/80 backdrop-blur-xl border-b border-slate-200/60 px-6 py-5 flex items-center justify-between flex-shrink-0 sticky top-0 z-10 shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
        <div>
          ...
          <p className="text-[12.5px] text-[#64748B]">
            Analyze hospital revenue, claims, and department financial
            performance (INR ₹).
          </p>
        </div>
      ...
      <div className="flex-1 overflow-auto p-6 flex flex-col gap-6 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-4 gap-4">
          {[
            ...
            <div
              key={i}
              className="bg-white border border-slate-200/60 p-6 rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-0.5 transition-all duration-300"
            >
              <div className="text-[12px] font-semibold text-slate-500 mb-3 tracking-wide">
                {stat.label}
              </div>
        ...
        <div className="flex gap-6 flex-1">
          ...
          <div className="flex-1 bg-white border border-slate-200/60 rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col overflow-hidden">
                ...
                {[
                  ...
                  <div key={i} className="group">
                    ...
                    <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden shadow-inner">
                      <div
                        className={`h-full ${row.color} rounded-full relative group-hover:brightness-110 transition-all duration-500`}
                        style={{ width: `${row.pct}%` }}
                      >
          ...
          <div className="w-96 bg-white border border-slate-200/60 rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col">
            ...
            <div className="p-8 flex-1 space-y-5 text-sm">
              <div className="flex justify-between items-center pb-3 border-b border-slate-100">
                ...
                <span className="font-bold text-slate-900 bg-slate-50 px-3 py-1 rounded-full">
                  ₹52,00,000
                </span>
              </div>
              <div className="flex justify-between items-center pb-3 border-b border-slate-100">
              ...
              <div className="flex justify-between items-center pb-3 border-b border-slate-100">
                ...
                <span className="font-bold text-red-500 bg-red-50 px-3 py-1 rounded-full">
                  ₹8,50,000
                </span>
              </div>
              <div className="flex justify-between items-center pb-3 border-b border-slate-100">
                <span className="text-slate-500 font-medium">
                  &gt; 90 Days{" "}
                  <span className="text-red-400 text-xs ml-1 font-semibold">
                    (Critical)
                  </span>
                </span>
              ...
              <div className="mt-8 bg-gradient-to-br from-rose-50 to-red-50/50 border border-rose-200/60 rounded-[20px] p-5 shadow-sm relative overflow-hidden">
                ...
                <p className="text-[12.5px] text-rose-700/80 mb-4 leading-relaxed">
                  Claim denials from Star Health increased by 4% this week due
                  to missing pre-authorizations.
                </p>
                <button className="text-[12.5px] font-bold text-rose-700 bg-white/60 hover:bg-white px-4 py-2 rounded-full transition-colors w-full text-center shadow-sm border border-rose-100 cursor-pointer">
                  View Denied Claims
                </button>
              </div>
            </div>
