...
const ELIGIBILITY = [
  { patient: "Thomas Reed", mrn: "100301", payer: "HDFC ERGO", plan: "Optima Restore Health", member: "HDFC-TE5-MK72", group: "—", status: "Verified", copay: "₹0", ded: "₹50,000 met", auth: "Not Required" },
  { patient: "John Smith", mrn: "100245", payer: "Star Health", plan: "Star Comprehensive Health", member: "SH-28847291", group: "EMR-44102", status: "Verified", copay: "₹2,500 inpatient", ded: "₹12,000 of ₹25,000", auth: "Approved" },
  { patient: "Mary Jones", mrn: "100246", payer: "ICICI Lombard", plan: "Complete Health Insurance", member: "ICICI-9920118", group: "GH-8812", status: "Verified", copay: "₹3,000 inpatient", ded: "₹0 remaining", auth: "Pending" },
  { patient: "Elena Vasquez", mrn: "100198", payer: "PM-JAY (Ayushman Bharat)", plan: "Ayushman Card Golden", member: "AB-0045512", group: "—", status: "Verified", copay: "₹0", ded: "₹0", auth: "Not Required" },
  { patient: "Patricia Okonkwo", mrn: "100149", payer: "Star Health", plan: "Star Health Premier", member: "SH-71199044", group: "GEN-2201", status: "Verification Pending", copay: "Unknown", ded: "Unknown", auth: "Required" },
  { patient: "Marcus Kim", mrn: "100377", payer: "Care Health", plan: "Care Supreme Plan", member: "CARE-4422981", group: "CORP-8821", status: "Verified", copay: "₹1,500 inpatient", ded: "₹8,000 of ₹30,000", auth: "Approved" },
];

const PRIOR_AUTHS = [
  { patient: "John Smith", mrn: "100245", service: "Inpatient Medical Admission", payer: "Star Health", submitted: "08/22/26", status: "Approved", authNum: "AUTH-2026-18845", expires: "08/28/26" },
  { patient: "Mary Jones", mrn: "100246", service: "CT Abdomen/Pelvis", payer: "ICICI Lombard", submitted: "08/21/26", status: "Pending", authNum: "—", expires: "—" },
  { patient: "Thomas Reed", mrn: "100301", service: "Cardiac Catheterization", payer: "HDFC ERGO", submitted: "—", status: "Not Required", authNum: "—", expires: "—" },
  { patient: "Marcus Kim", mrn: "100377", service: "Inpatient Cardiac Monitoring", payer: "Care Health", submitted: "08/20/26", status: "Approved", authNum: "CARE-2026-5541", expires: "08/27/26" },
  { patient: "Patricia Okonkwo", mrn: "100149", service: "Hip Replacement Surgery", payer: "Star Health", submitted: "08/23/26", status: "Pending", authNum: "—", expires: "—" },
  { patient: "Sandra Brown", mrn: "100331", service: "MRI Brain w/ & w/o", payer: "Bajaj Allianz", submitted: "08/15/26", status: "Denied", authNum: "BAJAJ-DENIED-8231", expires: "—" },
];
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#F0F2F5]">
      <div className="bg-white border-b border-[#DDE2EC] px-6 py-3 flex items-center justify-between">
        <div>
          <h1 className="text-base font-semibold text-gray-900">Insurance &amp; TPA Authorization</h1>
          <p className="text-[11.5px] text-[#64748B]">Revenue Cycle · Eligibility Verification &amp; Prior Pre-Authorization (INR ₹)</p>
        </div>
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <MetricCard label="Denials — MTD" value="7" sub="₹3.8 L at risk · 5 in appeal" color="#DC2626" />
        </div>

        {/* Alert */}
        <AlertBanner type="warning" title="Prior Auth Expiring Soon"
          body="John Smith (SH-28847291) — Inpatient auth expires Aug 28. Review if continued stay needed." action="Extend Auth" />
        ...
        <Card title="Denial Management — Active Cases">
          <div className="space-y-3">
            {[
              { patient: "Sandra Brown", service: "MRI Brain w/ & w/o", payer: "Bajaj Allianz", denialReason: "Medical necessity not established", amount: "₹42,000", daysLeft: 12, stage: "Appeal Filed" },
              { patient: "George Watts", service: "Extended ED Visit", payer: "Care Health", denialReason: "Level of service downgraded", amount: "₹18,500", daysLeft: 5, stage: "Peer Review Pending" },
              { patient: "Isabel Cruz", service: "Ankle MRI", payer: "ICICI Lombard", denialReason: "Requires X-ray first (step therapy)", amount: "₹21,000", daysLeft: 21, stage: "Resubmit with X-ray" },
            ].map((d, i) => (
