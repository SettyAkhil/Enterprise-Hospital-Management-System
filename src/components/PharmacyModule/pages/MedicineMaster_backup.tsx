      ...
      <PageHeader
        ...
        actions={
          <div className="flex gap-2">
            ...
            <button onClick={() => setShowModal(true)} className="flex items-center gap-1.5 px-4 py-2 rounded text-white text-[13px] font-medium" style={{ background: "#1B4FD8" }}>
              ...
              <tr key={m.id}>
                ...
                <td>
                  <div className="flex items-center gap-1">
                    ...
                    <button className="p-1.5 rounded hover:bg-[#FEE2E2] text-[#dc2626] transition-colors" title="Delete"><Trash2 size={13} /></button>
                  </div>
                </td>
              </tr>
            ))}
              ...
              <div className="grid grid-cols-2 gap-3">
                {["Medicine Name", "Generic Name", "Strength", "Dosage Form", "Manufacturer", "Category", "MRP (₹)", "Selling Price (₹)"].map(label => (
                  <div key={label}>
                    ...
                    <input className="w-full px-3 py-2 rounded border border-[#DDE2EC] text-[13px] text-[#0F1624] focus:border-[#1B4FD8] focus:outline-none transition-colors" />
                  </div>
                ))}
              </div>
              <div className="flex gap-3 pt-2">
                <button className="flex-1 py-2.5 rounded text-white font-semibold text-[13px]" style={{ background: "#1B4FD8" }}>Add Medicine</button>
