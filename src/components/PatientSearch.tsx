  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#F0F2F5]">
      ...
      <div className="bg-white border-b border-[#DDE2EC] px-6 py-3.5 flex items-center justify-between">
        ...
        <Btn variant="primary" size="sm" onClick={onRegister} className="rounded-none">
            ...
            return (
              ...
              >
                <div className="flex items-start gap-4">
                  {/* Avatar */}
                  <div className={`w-12 h-12 rounded-none flex items-center justify-center font-bold text-[15px] flex-shrink-0 shadow-xs ${
                    isFemale
                    ...
                    <div className="flex items-start justify-between gap-3 flex-wrap">
                      <div>
                        <div className="flex items-center gap-2.5 flex-wrap">
                          ...
                          <span className={`text-[10.5px] font-bold px-2 py-0.5 rounded-none border ${
                      ...
                      <div className="flex flex-col items-end gap-1">
                        {latestEncounter && (
                          <div className="flex items-center gap-2">
                            ...
                            <StatusBadge status={latestEncounter.status || "Registered"} className="rounded-none" />
                          </div>
                        )}
