...
export const Icon: Record<string, React.FC<IconProps>> = {
  ...
  Clinical: ({ className }) => (
    <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4.8 2.3A.3.3 0 0 0 4.5 2.6V5A7.5 7.5 0 0 0 12 12.5a7.5 7.5 0 0 0 7.5-7.5V2.6a.3.3 0 0 0-.3-.3h-2.4a.3.3 0 0 0-.3.3V5A4.5 4.5 0 0 1 12 9.5 4.5 4.5 0 0 1 7.5 5V2.6a.3.3 0 0 0-.3-.3H4.8z" />
      <path d="M12 12.5v4" />
