...
export default function Login({ onLogin }: LoginProps) {
  ...
  return (
    <div className="min-h-screen flex" style={{ background: "#0f172a" }}>
      {/* Left: Visual */}
      <div className="hidden lg:flex flex-col flex-1 relative overflow-hidden" style={{ background: "linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #0f766e 100%)" }}>
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-12 relative z-10">
          <div className="w-20 h-20 rounded-3xl flex items-center justify-center mb-8" style={{ background: "#0f766e" }}>
      ...
      <div className="w-full lg:w-[440px] flex flex-col justify-center bg-white p-10">
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-6 lg:hidden">
            ...
            <span className="font-bold text-[16px] text-[#0f172a]">MedCare Pharmacy</span>
          </div>
        ...
        <form className="space-y-5" onSubmit={e => { e.preventDefault(); onLogin(); }}>
          ...
          <div>
            <div className="flex justify-between mb-1.5">
              ...
              <button type="button" className="text-[12px] font-medium" style={{ color: "#2563eb" }}>Forgot password?</button>
            </div>
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••••"
              />
              <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-[#94a3b8] hover:text-[#374151]">
          ...
          <div className="flex items-center gap-2">
            <input id="remember" type="checkbox" checked={remember} onChange={e => setRemember(e.target.checked)} className="w-4 h-4 rounded border-[#e2e8f0] accent-[#2563eb]" />
