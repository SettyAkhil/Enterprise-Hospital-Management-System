    ...
    <section className="module-page">
      ...
      >
        ...
        >
          ...
          <p
            className="muted"
            style={{ margin: "0 0 1.25rem 0", fontSize: "0.875rem" }}
          >
            Add doctors to the administrative roster. They will automatically be
            available in Appointments & Symptom AI.
          </p>

          <form
            onSubmit={(e) => void handleDoctorSubmit(e)}
            ...
            <div>
              ...
              <Select
                ...
                onChange={(e) =>
                  setDoctorForm((prev) => ({
                    ...prev,
                    status: e.target.value as "available" | "leave",
                  }))
                }
              >
            ...
            >
              ...
              {doctorForm.id && (
                <Button
                  type="button"
                  variant="secondary"
                  onClick={() => setDoctorForm(DEFAULT_DOCTOR_FORM)}
                >
                  Cancel
                </Button>
              )}
            ...
            <div>
              {doctors.map((doc) => (
                ...
                >
                  ...
                  <TableCell style={{ fontWeight: 500, color: "#059669" }}>
                    ₹{Number(doc.consultation_fee || 0).toFixed(0)}
                  </TableCell>
                  <TableCell style={{ color: "#64748B" }}>
                    ₹{Number(doc.review_fee || 0).toFixed(0)}
                  </TableCell>
                  <TableCell>
                    <div
                      style={{
                    ...
                    >
                      ...
                      >
                        {doc.status === "available" || doc.status === "active"
                          ? "● Available"
                          : "○ On Leave"}
                      </span>
                      {doc.source === "users" && (
              ...
              {doctors.length === 0 && (
                <TableRow>
                  ...
                  >
                    No doctors added yet. Use the form on the left to add
                    doctors to the hospital roster.
                  </TableCell>
                </TableRow>
              )}
            </div>
